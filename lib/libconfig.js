...
var envDefaults = {
  ...
  , smtp_host : everypaas.getSMTP()[1]['host'] || ''
  , smtp_port : everypaas.getSMTP()[1]['port'] || 587
  , smtp_user : everypaas.getSMTP()[1]['auth']['user'] || ''
  , smtp_pass : everypaas.getSMTP()[1]['auth']['pass'] || ''
